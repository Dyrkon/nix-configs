{
  ...
  firefoxPath =
    ...
    then ".mozilla/firefox/${config.${namespace}.user.name}"
    else "/Users/${config.${namespace}.user.name}/Library/Application Support/Firefox/Profiles/${config.${namespace}.user.name}";
in {
