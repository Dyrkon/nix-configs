  ...
  config = mkIf (cfg.enable && pkgs.stdenv.isLinux) {
    programs.plasma = {
      ...
      configFile = {
        ...
        "dolphinrc"."ExtractDialog"."DirHistory[$e]" = "$HOME/Downloads/puget/,$HOME/Downloads/";
        ...
        "kcminputrc"."Libinput/1133/16505/Logitech G Pro "."PointerAcceleration" = "-0.200";
        ...
        "kdeglobals"."KScreen"."ScreenScaleFactors" = "HDMI-A-1=1.25;DP-1=1.25;";
        ...
        "kwinrc"."Tiling/245cd8a7-04a6-51b6-8260-67349c578c72"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.49921875000000004},{\"width\":0.50078125}]}";
        "kwinrc"."Tiling/291defdf-6bd0-5b85-8a8e-9c07879f55d8"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/3f9b2fe0-b808-541d-b422-982734173f8b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/473664b6-fa7f-542a-b5a8-349449aac8ba"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/54968eb2-cc1f-508f-82bc-43c785aef717"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/58493dec-332d-50c0-a66f-758c69fea3e0"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        ...
        "kwinrc"."Tiling/5fbd4bfe-f39f-5afe-816d-525ba4f5fb47"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/66826d36-6721-59ce-a647-de268d640a7f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/673e9211-643a-5ce2-9a6a-aaf98ec96912"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/68c99429-a66d-5c30-9fb7-2633b88b6b5e"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/7a177e72-a410-5cdf-b9f2-b0b233d7fb51"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/985982cf-19ff-5e8f-bbe7-db766c5d6c6b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/9cd1e8ad-4969-5c09-91e1-36d38a7f6c09"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/a02a749c-79af-51c9-8c15-6ac072f662a3"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/acbcac96-2181-5eeb-bbe0-57efee0d45cd"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/bf458aa9-6a09-5cd2-aa42-4761f96e45ef"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        ...
        "kwinrc"."Tiling/d19a7a3b-ddc8-5d0d-ac72-2ef90d1baeef"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/d1d9d62d-75bf-5618-8247-44ba38f94c2f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        ...
        "spectaclerc"."ImageSave"."lastImageSaveAsLocation" = "file:///home/dyrkon/Pictures/Screenshots/bis=otazka.png";
        "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/dyrkon/Pictures/Screenshots/bis=otazka.png";
